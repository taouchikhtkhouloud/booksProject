...
$sql = "SELECT id, title, description, nom, price FROM books WHERE nom='$nom'";
...
<html lang="en">
    ...
    <h4 class="center grey-text">My Books</h4>
    <div class="container">
        <div class="row">
                    ...
                    <div class="card z-depth-0">
                        ...
                        <div class="card-content center">
                            ...
                            <div class="card-action right-align">
                                <a href="detailmy.php?id=<?php echo $book['id']?>" class="brand-text">more info</a>
                            </div>
                        </div>
                    </div>
                </div>
